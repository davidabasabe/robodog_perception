...
#ifndef ROS_BT_PY_INTERFACES__MSG__DETAIL__NODE__TRAITS_HPP_
#define ROS_BT_PY_INTERFACES__MSG__DETAIL__NODE__TRAITS_HPP_
...
inline void to_yaml(
  const ros_bt_py_interfaces::msg::Node & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ros_bt_py_interfaces::msg::Node & msg)
{
  return ros_bt_py_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ros_bt_py_interfaces::msg::Node>()
{
  return "ros_bt_py_interfaces::msg::Node";
}

template<>
inline const char * name<ros_bt_py_interfaces::msg::Node>()
{
  return "ros_bt_py_interfaces/msg/Node";
}

template<>
struct has_fixed_size<ros_bt_py_interfaces::msg::Node>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros_bt_py_interfaces::msg::Node>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<ros_bt_py_interfaces::msg::Node>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROS_BT_PY_INTERFACES__MSG__DETAIL__NODE__TRAITS_HPP_
