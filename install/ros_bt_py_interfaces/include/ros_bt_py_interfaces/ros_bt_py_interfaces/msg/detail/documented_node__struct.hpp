...
#ifndef ROS_BT_PY_INTERFACES__MSG__DETAIL__DOCUMENTED_NODE__STRUCT_HPP_
#define ROS_BT_PY_INTERFACES__MSG__DETAIL__DOCUMENTED_NODE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros_bt_py_interfaces__msg__DocumentedNode __attribute__((deprecated))
#else
# define DEPRECATED__ros_bt_py_interfaces__msg__DocumentedNode __declspec(deprecated)
#endif
...
struct DocumentedNode_
{
  using Type = DocumentedNode_<ContainerAllocator>;

  explicit DocumentedNode_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit DocumentedNode_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : module(_alloc),
    node_class(_alloc),
    version(_alloc),
    name(_alloc),
  ...
  // pointer types
  using RawPtr =
    ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros_bt_py_interfaces__msg__DocumentedNode
    std::shared_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_bt_py_interfaces__msg__DocumentedNode
    std::shared_ptr<ros_bt_py_interfaces::msg::DocumentedNode_<ContainerAllocator> const>
  ...
  bool operator==(const DocumentedNode_ & other) const
  {
...
using DocumentedNode =
  ros_bt_py_interfaces::msg::DocumentedNode_<std::allocator<void>>;

// constant definitions
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::UNINITIALIZED = "UNINITIALIZED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::IDLE = "IDLE";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::RUNNING = "RUNNING";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::SUCCEEDED = "SUCCEEDED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::SUCCEED = "SUCCEEDED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::SUCCESS = "SUCCEEDED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::FAILED = "FAILED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::FAIL = "FAILED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::FAILURE = "FAILED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::BROKEN = "BROKEN";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::PAUSED = "PAUSED";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
DocumentedNode_<ContainerAllocator>::SHUTDOWN = "SHUTDOWN";

}  // namespace msg

}  // namespace ros_bt_py_interfaces

#endif  // ROS_BT_PY_INTERFACES__MSG__DETAIL__DOCUMENTED_NODE__STRUCT_HPP_
