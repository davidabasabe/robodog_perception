...
{
  new (message_memory) ros_bt_py_interfaces::msg::NodeData(_init);
}

void NodeData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_bt_py_interfaces::msg::NodeData *>(message_memory);
  typed_message->~NodeData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeData_message_member_array[3] = {
  {
    "key",  // name
    ...
    offsetof(ros_bt_py_interfaces::msg::NodeData, key),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_bt_py_interfaces::msg::NodeData, serialized_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_bt_py_interfaces::msg::NodeData, serialized_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NodeData_message_members = {
  ...
  3,  // number of fields
  sizeof(ros_bt_py_interfaces::msg::NodeData),
...
{
  return &::ros_bt_py_interfaces::msg::rosidl_typesupport_introspection_cpp::NodeData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_bt_py_interfaces, msg, NodeData)() {
  return &::ros_bt_py_interfaces::msg::rosidl_typesupport_introspection_cpp::NodeData_message_type_support_handle;
}
