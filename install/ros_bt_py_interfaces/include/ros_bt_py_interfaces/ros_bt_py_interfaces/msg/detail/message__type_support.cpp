...
{
  new (message_memory) ros_bt_py_interfaces::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_bt_py_interfaces::msg::Message *>(message_memory);
  typed_message->~Message();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[3] = {
  {
    "msg",  // name
    ...
    offsetof(ros_bt_py_interfaces::msg::Message, msg),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_bt_py_interfaces::msg::Message, service),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_bt_py_interfaces::msg::Message, action),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Message_message_members = {
  ...
  3,  // number of fields
  sizeof(ros_bt_py_interfaces::msg::Message),
...
{
  return &::ros_bt_py_interfaces::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_bt_py_interfaces, msg, Message)() {
  return &::ros_bt_py_interfaces::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
