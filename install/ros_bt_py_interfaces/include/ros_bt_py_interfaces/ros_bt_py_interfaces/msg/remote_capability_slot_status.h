...
#ifndef ROS_BT_PY_INTERFACES__MSG__REMOTE_CAPABILITY_SLOT_STATUS_H_
#define ROS_BT_PY_INTERFACES__MSG__REMOTE_CAPABILITY_SLOT_STATUS_H_
...
#endif  // ROS_BT_PY_INTERFACES__MSG__REMOTE_CAPABILITY_SLOT_STATUS_H_
