...
#ifndef ROS_BT_PY_INTERFACES__SRV__DETAIL__ADD_NODE_AT_INDEX__FUNCTIONS_H_
#define ROS_BT_PY_INTERFACES__SRV__DETAIL__ADD_NODE_AT_INDEX__FUNCTIONS_H_
...
/// Initialize srv/AddNodeAtIndex message.
/**
...
/// Finalize srv/AddNodeAtIndex message.
/**
...
/// Create srv/AddNodeAtIndex message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Request__init().
...
/// Destroy srv/AddNodeAtIndex message.
/**
 * It calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Request__fini()
...
/// Check for srv/AddNodeAtIndex message equality.
/**
...
/// Copy a srv/AddNodeAtIndex message.
/**
...
/// Initialize array of srv/AddNodeAtIndex messages.
/**
...
/// Finalize array of srv/AddNodeAtIndex messages.
/**
 * It calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Request__fini()
...
/// Create array of srv/AddNodeAtIndex messages.
/**
 * It allocates the memory for the array and calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddNodeAtIndex messages.
/**
 * It calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddNodeAtIndex message array equality.
/**
...
/// Copy an array of srv/AddNodeAtIndex messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_bt_py_interfaces
...
/**
 * It calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_bt_py_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_bt_py_interfaces
...
/**
 * It calls
 * ros_bt_py_interfaces__srv__AddNodeAtIndex_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS_BT_PY_INTERFACES__SRV__DETAIL__ADD_NODE_AT_INDEX__FUNCTIONS_H_
